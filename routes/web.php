...
use App\Http\Controllers\DashboardController; // Mengimpor HomeController dari App\Http\Controllers
use App\Http\Controllers\HomeController; // Mengimpor DashboardController dari App\Http\Controllers
use App\Http\Controllers\PaketWisataController; // Mengimpor ProfileController dari App\Http\Controllers
use App\Http\Controllers\PesananController; // Mengimpor PesananController dari App\Http\Controllers
use App\Http\Controllers\ProfileController; // Mengimpor UserController dari App\Http\Controllers
use App\Http\Controllers\UserController; // Mengimpor PaketWisataController dari App\Http\Controllers
use Illuminate\Support\Facades\Route;
// Mengimpor facade Route dari Illuminate\Support\Facades
